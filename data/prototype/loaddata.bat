...
%OGRBIN%\ogrinfo -ro PG:%PGCONN% -sql "INSERT INTO data.element_types (elt_id, geom_type, priority, footprint_params, clearance_category, topology_participant) VALUES (2490200,2,1,'{\"buffer\":{\"radius\":3}}',1,true)"
...
REM vodni kanal
%OGRBIN%\ogrinfo -ro PG:%PGCONN% -sql "INSERT INTO data.element_types (elt_id, geom_type, priority, footprint_params, clearance_category, topology_participant) VALUES (3030000,2,1,'{\"buffer\":{\"radius\":6}}',1,true)"
%OGRBIN%\ogrinfo -ro PG:%PGCONN% -sql "INSERT INTO data.element_types (elt_id, geom_type, priority, footprint_params, clearance_category, topology_participant) VALUES (3040000,2,1,'{\"buffer\":{\"radius\":6}}',1,false)"
REM brehovka
...
%OGRBIN%\ogrinfo -ro PG:%PGCONN% -sql "TRUNCATE data.elements CASCADE"
for /R %~dp0 %%i IN (*.shp) do (
  ...
  -sql "INSERT INTO data.elements (elt_id, source_id, source_elt_id, geom) SELECT elt_id, source_id, source_elt_id, ST_SetSrid(wkb_geometry, 0) FROM data.temp_elements"
